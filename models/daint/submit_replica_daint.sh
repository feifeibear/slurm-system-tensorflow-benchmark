...
source $WORKON_HOME/horovod_0314/bin/activate
UPDATE_METHOD=horovod

mkdir -p srun_log
export PYTHON=python3
srun -N ${SLURM_JOB_NUM_NODES} -n ${SLURM_JOB_NUM_NODES} ${PYTHON} ../../scripts/tf_cnn_benchmarks/tf_cnn_benchmarks.py --num_gpus=1 --batch_size=160 --model=resnet50 \
--variable_update=${UPDATE_METHOD} > ./srun_log/${UPDATE_METHOD}_${SLURM_JOB_NUM_NODES}_B64_nodes.log 
